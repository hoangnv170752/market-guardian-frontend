// Mock data for Market Guardian Portal
...
// Policies data - Điều khoản sử dụng
export const policies: Policy[] = [
  {
    id: "KGR001",
    title: "Điều khoản sử dụng",
    version: "KGR001",
    content: "Tập đoàn Kangaroo chỉ chấp nhận những Đơn đặt hàng khi cung cấp đủ thông tin chính xác về Họ tên, Địa chỉ, Số điện thoại... Sau khi Quý khách liên hệ đặt hàng, chúng tôi sẽ liên lạc lại để kiểm tra thông tin và thỏa ...",
    status: "active"
  },
  {
    id: "KGR003",
    title: "Điều khoản đổi trả hàng",
    version: "KGR003",
    content: "Tập đoàn Kangaroo chỉ chấp nhận những Đơn đặt hàng khi cung cấp đủ thông tin chính xác về Họ tên, Địa chỉ, Số điện thoại... Sau khi Quý khách liên hệ đặt hàng, chúng tôi sẽ liên lạc lại để kiểm tra thông tin và thỏa ...",
    status: "inactive"
  },
...
export const getCitiesByType = (type: 'tinh' | 'thanh-pho'): City[] => {
  return Object.values(cities).filter(city => city.type === type);
};
...
export const searchCities = (query: string): City[] => {
  ...
  return Object.values(cities).filter(city => 
    ...
    city.name_with_type.toLowerCase().includes(lowerQuery)
  );
};
